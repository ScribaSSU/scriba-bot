...
public class MessageText {
    ...
    public static final String CHOOSE_COURSE = "Выберите курс. Если учитесь в колледже, выберите 'Другое'.";
    public static final String CHOOSE_STUDENT_GROUP = "Введите номер группы в формате 'г номер_группы'. Буква 'г' и пробел после нее обязательны!";
