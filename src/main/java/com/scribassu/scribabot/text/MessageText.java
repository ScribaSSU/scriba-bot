...
public class MessageText {
    ...
    public static final String GREETING_WITH_CHOOSE_DEPARTMENT = "Привет! Для начала работы с ботом нужно выбрать факультет и группу. Если клавиатура для выбора факультета не пришла, напишите сюда же любое сообщение, чтобы оповестить админа, админ увидит и поможет.\n\n" +
            "Также вы можете ввести факультет вручную: биолог, географ, геолог, идпо, и-т искусств, ииимо, и-т физики, и-т физ кул, ифиж, и-т химии, мехмат, фияил, книит, соцфак, ффмимт, психолог, пписо, философ, эконом, юрфак, геолог к-ж, к-ж яблочкова";
    ...
    public static final String CHOOSE_DAY_FOR_TEACHER_SCHEDULE = "Выберите, для чего хотите узнать расписание преподавателя. Для сброса поиска выберите на клавиатуре 'Главное меню' или 'Выйти из расписания преподавателя' или введите вручную 'меню'.";
